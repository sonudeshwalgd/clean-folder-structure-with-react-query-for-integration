...
export default function AddFilePopup({
  ...
  const patchHandler = () => {
    ...
    payload.append("id", payloadId);
    payload.append("pdfFile", Publication.current.files[0]);
    payload.append("name", Title.current.value);
    console.log(payload);
              ...
              <div className="foam">
                <div className="foam_field">
                  <div className="full">
                    ...
                    ></input>
                    <p style={{ display: "none" }}>Enter File Name</p>
                  </div>
                  <div className="full ">
                    <p>Attachment</p>
                    <label htmlFor="email" className="choose-button">
                      Choose File And Upload
                    </label>
                    <input
                      onChange={() => patchHandler()}
                      style={{ display: "none" }}
                      ref={Publication}
                      type="file"
                      id="email"
                    ...
                    ></input>
                    <p style={{ display: "none" }}>Add Attachment</p>
                  </div>

                  <div className="full">
                    {/* <button className="submit" onClick={()=> patchHandler()}>Send</button> */}
                  </div>
                </div>
              </div>
            </div>
